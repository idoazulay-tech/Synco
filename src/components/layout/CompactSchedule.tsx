    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed top-0 right-0 bottom-0 w-28 bg-background/95 backdrop-blur-sm border-l border-border z-40 shadow-xl"
        >
          <div className="h-full flex flex-col">
            ...
            <div className="flex border-t border-border">
              <button
                ...
                className="flex-1 p-2 text-[10px] text-center text-primary hover:bg-secondary transition-colors"
              ...
              <button
                onClick={onClose}
                className="p-2 border-l border-border hover:bg-secondary transition-colors"
