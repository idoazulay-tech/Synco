...
// TaskBlockMode is imported from AdaptiveTaskBlockContent
// getTaskBlockMode, getAdaptivePadding also imported from AdaptiveTaskBlockContent
...
const TaskItem = ({ 
  ...
  // 4-mode adaptive: micro / tiny / compact / full
  const blockMode: TaskBlockMode = getTaskBlockMode(position.height);
  const padding      = getAdaptivePadding(actualHeight, blockMode);
  ...
  return (
    ...
    >
      ...
      {/* ── Drag / click interaction wrapper ── */}
      <div
        className={cn(
